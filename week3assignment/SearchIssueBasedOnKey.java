...
public class SearchIssueBasedOnKey extends BaseClass {
@Test(dependsOnMethods="week3assignment.CreateJiraIssue.Createissue")
public void SearchIssueByKey() {
	...
	Response response = inputreq.get(Key);
	System.out.println(response.getStatusCode());
	response.prettyPrint();
	response.then().assertThat().statusCode(200);
	System.out.println("Issues has been retrieved based on the input key");
